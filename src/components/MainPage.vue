    ...
    <div id="content" class="content" style="display: none;">
                    ...
                    <div class="element1">
                        <div class="content1">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="971.0518" height="628.38145" viewBox="0 0 971.0518 628.38145" role="img"
                ...
                <div class="box">
                    <div class="element2">
                        ...
                        <div class="content6">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="697.48425" height="461.23435" viewBox="0 0 697.48425 461.23435" role="img"
                                artist="Katerina Limpitsouni" source="https://undraw.co/">
                                <path
                ...
                <div class="box">
                    <div class="element3">
                        <div class="content10">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="987.58708" height="714.02784" viewBox="0 0 987.58708 714.02784" role="img"
                                artist="Katerina Limpitsouni" source="https://undraw.co/">
                                <path
        ...
        <div class="third-section" id="third">
            ...
            <div class="main-projects-show">
                            ...
                            <div class="project" id="project">
                                <div class="project-info">
                                    ...
                                    <div class="project-content">
                                        <p style="font-size: 22px;">{{ t('Projects.UnpAbout') }} <a
                                                href="https://unpnews.com/">https://unpnews.com/</a></p>
                ...
                <!-- Outra caixa de projeto que vou utilizar no futuro -->
                <div class="element-container">
                    <div class="box">
                        <div class="project-container scroll">
                            ...
                            <div class="project" id="project">
                                <div class="project-info">
                                    ...
                                    <div class="project-content">
                                        <p style="font-size: 22px;">{{ t('Projects.Portfolio') }} <a
                                                href="https://arthurbarcelosportfolio.netlify.app/">https://arthurbarcelosportfolio.netlify.app/</a>
                                        </p>
                                        <p style="font-size: 22px;">{{ t('Projects.Portfolio2') }}</p>
                        ...
                        <div class="project-container scroll">
                            ...
                            <div class="project" id="project">
                                <div class="project-info">
                                    ...
                                    <div class="project-content">
                                        <p style="font-size: 22px;">{{ t('Projects.Clicker') }} <a
                                                href="https://justanotherclicker.netlify.app/">https://justanotherclicker.netlify.app/</a>
                                        </p>
                                        <p style="font-size: 22px;">{{ t('Projects.Clicker2') }}</p>
            ...
            <!-- Aba de designs desativada para implementação futura -->
            <div class="Ptxtfield" style="display: none;">
                <h1>Designs</h1>
            </div>
            <div class="element-container" style="display: none;">
                <div class="box">
                    <div class="project-container scroll">
                        <div class="project" id="project">
                            <div class="project-info">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    input.addEventListener('keyup', (e) => {
        ...
        if (e.key === 'Enter') {
            if (input.value.trim() === 'Start' || input.value.trim() === 'start' || input.value.trim() === 'START' || input.value.trim() === 'Iniciar' || input.value.trim() === 'iniciar' || input.value.trim() === 'INICIAR') {
